...
$lang=array(
       ...
       'agreement_signed_complete_wait_witkey'=>'协议签署完成,等待卖家(伯乐)签署协议！',
       'agreement_link'=>'协议链接',
       ...
       'source_file_confirm_deliver_success'=>'源文件确认完成，职位交付成功!',
       'file_confirm_fail_deliver_fail'=>'源文件确认失败，职位交付失败!',
       'current_status_can_not_confirm'=>'协议当前状态无法确认附件',
       'wait_sign'=>'待双方签署',
       'agreement_sign_complete'=>'协议签署完成',
       'task_order_complete'=>'职位交易完成'
);