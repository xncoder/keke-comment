...
*/
$lang=array(
			'witkey_task_exist_error'=>'伯乐合作网站职位已存在',
			'witkey_recharge_exist_error'=>'伯乐合作网站职位奖金已支付',
			'recharge_info_modified'=>'充值数据被修改',
			'platform_authority_illegal'=>'操作权限限制',
			'witkey_recharge_id_empty'=>'职位充值id为空',
			'witkey_recharge_empty'=>'职位充值记录为空',
			'witkey_task_not_exist'=>'职位不存在',
