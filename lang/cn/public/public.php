...
/**职位和商城公共**/
	...
	'seller_info'=>'卖家信息',
	//task_info
	'view_shop_space'=>'查看TA的空间',
	'task_bider'=>'中标者',
	'de_mark'=>'的点评',
	'bid_give_cash'=>'进入面试环节即可获得伯乐奖',
	'only_one_can_bid'=>'雇主只向推荐成功的伯乐颁奖',
	'employer_confirmed_the_task_is_completed'=>'雇主选择中标者后，交付将在线下完成，雇主确认后，职位完成',
...
//职位
	...
	'task_status'=>'职位状态',
    'my_canyu'=>'我参加的',
    'task_model_close'=>'职位模块已被关闭、无可用数据',
    'task_id'=>'职位编号',
    'task_index'=>'职位首页',
    'task_map'=>'职位地图',
	'shop_map'=>'商品地图',
...
//类文件的公共
	...
	'deal_fail_now_forbit_deal_cash'=>'处理失败,当前无法进行奖金分配',
	//task
	'not_exsist_relation_task_and_not_user_onekey'=>'不存在的关联职位，无法使用一键模式',
	'task_min_cash_limit_notice'=>'职位最小金额不能低于',
	'able_value'=>'能力值',
	'task_link'=>'职位链接',
	'from_hand_work_deadline'=>'距推荐截止',
    'from_hand_bid_deadline'=>'距投标截止',
	'task_working_can_hand_work'=>'推荐赛事进行中，欢迎踊跃参赛',

    'task_nopay_can_not_look'=>'您还没有支付伯乐奖金，其他用户无法查看',
    'wait_patient_to_audit'=>'您发布的职位还没有通过审核，请耐心等待',
    'hand_work_and_reward_trust'=>'接受推荐中，伯乐奖金已托管到本站，请放心推荐',
    'work_choosing_and_wait_employer_choose'=>'推荐期结束，选稿中，请等候雇主确定最终获奖结果',
    'task_gs_and_emplyer_have_choose'=>'获奖公示中，雇主已选出中奖伯乐', 
    'task_frozen_can_not_operate'=>'职位被冻结啦，现在无法操作',
    'task_over_congra_witkey'=>'该职位招聘成功，伯乐奖已成功发放，恭喜获得奖金的优秀伯乐！', 
    'pity_task_fail'=>'很遗憾，该职位招聘失败，无人获得伯乐奖，但所推荐的千里马在一年内被雇主录用，伯乐奖仍归推荐者所得！',
    'fail_audit_please_repub'=>'您的职位审核失败，请重新发布', 
    'wait_for_task_arbitrate'=>'职位在仲裁中，请耐心等待', 
    'no_choosing_wait_for_vote'=>'雇主没有选出获奖伯乐，等待用户投票', 
    'employer_and_witkey_jf'=>'雇主和选中的投稿人正在进行交付',  
    'task_frozen_when_jf'=>'职位在交付阶段被冻结了 ', 
    'bidding_and_eagerly_tender'=>'职位投标中，踊跃投标哦',
    'bidding_and_wait_employer_choose'=>'职位选标中，正在等待雇主选标',
    'bidder_working'=>'中标的家伙正在努力工作中',
    'task_over_for_jf'=>'工作完成了，正在等待雇主确认',
    'bidding_for_reward_trust'=>'已经选中标，雇主还没托管奖金',
    'work_over_for_jf'=>'职位已经完成了，双方正在交付',
    'reward_trust_and_bidding_match'=>'奖金已托管，快来抢标，先抢先得',
    'bid_and_both_consult'=>'已经有人中标，双方协商中',
    'the_other_confirm'=>'对方正在确认中',
    'bid_witkey_work'=>'已经选中伯乐，努力工作中',
    'work_over_employer_accepting'=>'职位已完成，雇主正在验收',

	'now_employer_can_choose_work'=>'当前阶段雇主可以选稿',
	'from_choose_deadline'=>'距选稿截止',
	'task_choosing_wait_employer_choose'=>'职位选稿中、等待雇主选稿',
	'from_vote_deadline'=>'距投票截止',
	'task_voting_can_vote'=>'职位进入投票阶段、欢迎积极投票',
	'from_gs_deadline'=>'距公示截止',
	'task_haved_choose_bid_and_user_look'=>'职位已选标，用户可以此职位进行监督',
	'task_in_jf_rate'=>'职位已进入交付阶段',
	'task_diffrent_opnion_and_web_in'=>'职位存在异议，网站已介入，此职位被冻结',
	'task_haved_complete'=>'职位已圆满完成',
	'task_timeout_and_no_works_fail'=>'职位逾期没有选稿，到期失败',
	'de_work'=>'的稿件',
	'call'=>'称谓',
	'you'=>'您',
	'task_hand'=>'职位交稿',
	...
	'vote'=>'投票',
	'vote_fail'=>'投票失败!',
	'task_fail_notice'=>'职位失败通知',
	'choose_no_body_hand_work'=>'投稿期无人投稿、职位已失败、由于是担保职位，请等待管理员解冻职位款项。',//s
	'task_pay_success_and_task_pub_success'=>'付款成功，你的职位已成功发布！',
	'task_pay_success_and_wait_admin_audit'=>'付款成功，由于你的职位金额在审核金额内，请耐心等待管理员审核！',
	...
	'arbitrate'=>'仲裁',
	'task_arbitrating'=>'职位仲裁中',
	'assure_return_cash'=>'担保退款',
	'agreement_frozen'=>'交付冻结',
	'now_status_can_not_choose'=>'当前职位不处于选稿期,无法选稿！',
	'the_work_is_out_and_not_choose_the_work'=>'当前稿件是淘汰稿件, 无法选择此稿件中标！',
	'task_have_bid_work_and_not_choose_the_work'=>'当前职位已有中标稿件,无法选择此稿件中标！',
	'the_work_is_not_choose_and_not_choose_the_work'=>'当前稿件不可选标, 无法选择此稿件中标！',
	'task_timeout_and_sys_auto_choose_work'=>'职位到期结束.系统自动选稿。',
	...
	'task_diffrent_opnion_and_web_in_zc'=>'职位存在异议，网站已介入，此职位仲裁中',
	'reward_trust'=>'奖金托管',
	'task_pub_time'=>'职位发布时间',
	'single_successful_mode'=>'单人独得模式',
	'match_task'=>'速配职位',
	'stay_left'=>'停靠在左边',
	'_miao_'=>'描',
	'_gao_'=>'稿',
...
/**show_msg.htm**/
	...
	'here'=>'这里',
	'system_message' => '系统短信',
	'goods_pay_success'=>'伯乐作品付款成功',
	'goods_pay_fail'=>'伯乐作品付款失败',
	'service_pay_success'=>'伯乐作品付款成功',
	'service_pay_fail'=>'伯乐作品付款失败',
/*add*/
    //protocol.php
    'the_agreement_not_exist'=>'该协议不存在',
   //release.htm
    'view_i_release_the_task'=>'查看我发布的职位',
    'firend_link'=>'友情连接',
...
/*match task**/
	...
	'get_part_host_cash'=>'获得了部分职位佣金;',
    'description'=>'描述',
	'success_bid_haved'=>'成功中标了',
	'match_task_trans_result'=>'速配职位客服处理结果如下:',
	'match_website_deal_notice'=>'速配职位客服处理通知',
	'currency'=>'币种',
	'wait_choose'=>'待选稿',
/*后台树型分类**/
...
/**order_sub.htm**/
	...
	'cash_msg'=>'金额',
	'admin_unfrize'=>'管理员解冻',
	'task_auth_success'=>'职位通过审核',
	'task_auth_fail'=>'职位审核失败',
	'user_unfreeze'=>'用户解冻',
	'user_msg'=>'用户',
	'work_status'=>'稿件状态',
	/**release_step2.htm**/
	'has_problem_contact'=>'如在发布职位时遇到麻烦，请联系',
