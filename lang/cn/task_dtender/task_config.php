...
//task_config_php
	...
	'modified_deposit_bidding_task'=>'修改了定金招标职位的',
//task_config_htm
	'whether_private_model'=>'是否为私有模型',
	'private_model_not_release_task_list'=>'私有模型不会出现在发布职位的选择列表上',
 	'industry_binding'=>'行业绑定',
	'select_industry'=>'选择行业',
	'you_can_choose'=>'行业绑定后的职位模型只能在选择该行业时候使用,可以多选.',
...
//task_control_htm
 	...
 	'task_commission_tactics_setting'=>'职位佣金策略设定',
	'tender_deposit'=>'招标订金',
	'tender_deposit_input_error'=>'招标订金输入有误',
 	'tender_deposit_range'=>'招标订金的范围是10-10000元',
	'yuan'=>'元(招标订金的范围是10-10000元，职位失败，订金不退还)',
	'task_percentage'=>'职位提成比例',
