		...
		if (isset ( $auth_code )) {
			switch (is_array ( $auth_code )) {
				case "0" :
					...
					$res and kekezu::admin_show_msg($_lang['auth_item_delete_success_notice'],$_SERVER['HTTP_REFERER'],'3','','success')	or kekezu::admin_show_msg($_lang['auth_item_delete_fail'],$_SERVER['HTTP_REFERER'],'3','','error');
					break;
				case "1" :
					...
					if (sizeof ( $auth_code_str )) {
						...
						$res and kekezu::admin_show_msg($_lang['auth_item_mulit_delete_success'],$_SERVER['HTTP_REFERER'],'3','','success') or $res and kekezu::admin_show_msg($_lang['auth_item_mulit_delete_fail'],$_SERVER['HTTP_REFERER'],'3','','error');
					}
					break;
			}
		}
