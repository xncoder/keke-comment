...
if($task_id){ 
	...
	switch ($ac) {
		...
		case "pass" : //通过审核
			...
			$v_arr = array($_lang['username']=>$task_audit_arr['username'],Conf::$msgTpl['task_link']=>$url,$_lang['start_time']=>$start_time,$_lang['end_time']=>$end_time,Conf::$msgTpl['task_id']=>"#".$task_id); 
		...
		case "nopass" : //审核失败
			...
			$v_arr = array($_lang['username']=>$task_audit_arr['username'],Conf::$msgTpl['task_title']=>$url,$_lang['website_name']=>$kekezu->_sys_config['website_name']); 
